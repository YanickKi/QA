...
\begin{frame}{Simulated annealing}
  ...
  \begin{itemize}
    ...
    \end{itemize}
  \end{itemize}
  \begin{textblock*}{6cm}(10.4cm,2.05cm) % {block width} (coords)
...
\begin{frame}{Quadratic unconstrained binary optimization constrains} \pause
  \begin{itemize}
...
\begin{frame}{Quantum annealer von D-Wave Systems}
  \begin{itemize}
    ...
    \item Qantum Processing Unit (QPU) mit QUBITs und couplern \pause
    \begin{itemize}
      \item QUBITs und coupler sind gewichtet  \pause
    \end{itemize}
    \item neuste Version: 5000 QUBITs mit 15 couplern pro QUBIT \pause
  ...
  \end{itemize}
  \vspace*{1cm} 
  Unterschied zu Quantencomputer \pause
    \begin{itemize}
...
\begin{frame}{Embedding}
  ...
  \end{textblock*}
   \begin{itemize}
    \item Ising Problem äquivalent zu QUBO Problem auf dem selben Graph $G$ \pause
    \begin{itemize}
...
\begin{frame}{Minor embedding}
  ...
  \begin{textblock*}{6cm}(8.5cm, 4.5cm) % {block width} (coords)
    ...
    \hspace*{12pt}\hbox{\scriptsize {\footnotesize\itshape \href{https://doi.org/10.1016/j.physrep.2012.10.002}{Choi, V., \textit{D-Wave Systems Inc.} (2008)}}}
  \end{textblock*}
\end{frame}
